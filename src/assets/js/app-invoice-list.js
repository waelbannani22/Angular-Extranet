    ...
    (a = e.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (a, e, t, s) {
            return (
              '<a href="app-invoice-preview.html">#' + t.invoice_id + "</a>"
            );
          },
        },
        {
            ...
            return (
              ...
              (!0 === r
                ...
                : '<span class="avatar-initial rounded-circle bg-label-' +
                  ...
                  "</span>") +
              '</div></div><div class="d-flex flex-column"><a href="pages-profile-user.html" class="text-body text-truncate fw-semibold">' +
              n +
